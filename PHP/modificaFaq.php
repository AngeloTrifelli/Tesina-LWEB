...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <style type="text/css">
            <?php include "../CSS/modificaFaq.css" ?>
        </style>
        ...
        <div class="containerCentrale">
            ...
            <div class="mainArea">
                    <div class="zonaSuperiore">
                        <div class="zonaSx">
                            <span class="item">Testo della domanda:</span>
                            <p><?php echo $faq['testoDomanda']; ?></p>
                        </div>
                        <div class="zonaDx">

                            <span class="item">Modifica il testo della risposta:</span>
                            <textarea type="text" class="textInput note" name="risposta"><?php echo $faq['testoRisposta']; ?></textarea>    
